...
// PSD distance
float readPSD() {
  int volt = map(analogRead(PSD_PIN), 0, 1023, 0, 5000);
  dist = (27.61 / (volt - 0.1696)) * 1000.0;
...
void processReqCmd(char *cmd) {
  ...
  case 2:
    ...
    break;
  case 3:
    commPort.print("P="); commPort.print(distance); commPort.write('\n');
    break;
  default:
